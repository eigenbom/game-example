...
inline std::string to_string(MobType type){
  ...
  switch (type){
    default:
    case MobType::Unknown:    return "MobType::Unknown"s;
    case MobType::Rabbit:     return "MobType::Rabbit"s;
    case MobType::RabbitWere: return "MobType::RabbitWere"s;
    case MobType::Snake:      return "MobType::Snake"s;
    case MobType::OrcWeak:    return "MobType::OrcWeak"s;
    case MobType::OrcStrong:  return "MobType::OrcStrong"s;
    case MobType::Player:     return "MobType::Player"s;
  }
}
